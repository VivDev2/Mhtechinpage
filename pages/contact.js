            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div className="mb-12 max-w-[570px] lg:mb-0">
                ...
                <p className="text-body-color mb-9 text-base leading-relaxed">
                  If You Fill Any Query Or Problem Please Fill Out Form Our Team Will Reach You Within 24 Hourse.
                </p>
                <div className="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div className ="w-full">
                    ...
                    <p className="text-body-color text-base">
                      MHTECHIN COMPLEX, CHH.SAMBHAJINAGAR, MAHRASHTRA,INDIA,431001.
                    </p>
                  </div>
                </div>
                <div className ="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div className="w-full">
                    ...
                    <p className="text-body-color text-base">(+91)73 978 315 53</p>
                  </div>
                </div>
                <div className="mb-8 flex w-full max-w-[370px]">
                  <div
                  ...
                  <div className="w-full">
                    ...
                    <p className="text-body-color text-base">support@mhtechin.in</p>
                  </div>
                </div>
              </div>
            </div>
